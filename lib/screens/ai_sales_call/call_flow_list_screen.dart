...
class _CallFlowListScreenState extends State<CallFlowListScreen> {
  ...
  List<Map<String, dynamic>> get _filtered {
    ...
    return _flows
        .where(
          (f) => (f['categoryName'] ?? '').toString().toLowerCase().contains(q),
        )
        .toList();
  }
  ...
  void _openBuilder(String categoryId, String categoryName) async {
    await Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => CallFlowBuilderScreen(
              ...
              ? Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text(
                        'Flows are linked to categories',
                        style: TextStyle(
                          fontSize: 12,
                  ...
                  Row(
                    children: [
                      Icon(
                        ...
                        size: 12,
                        color: hasFlow ? AppColors.success : AppColors.textHint,
                      ),
